...
# Listen on 8080 (non-root friendly), set server name, disable dir listing
...
# Clean default content, redirect logs to stdout/stderr for docker logs
...
# Persistent playbook storage — Docker volume mounted here at runtime
